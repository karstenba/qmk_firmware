...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_karstenba(
		...
		MO(1),                KC_LGUI, KC_LALT,                            KC_SPC,                    MO(1),   KC_RALT, KC_RGUI, KC_RCTRL,  _______),

	LAYOUT_karstenba(
		_______,              KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,    KC_DEL, _______,
		_______,              _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MPLY, _______,   _______,
